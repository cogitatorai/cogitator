...
// Enable activates the connector. It attempts an initial connection but
// returns nil even when Chrome is unreachable; the background poller will
...
// Disable deactivates the connector, stops polling, and closes the CDP client.
